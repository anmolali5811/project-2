...
const HaveQuestion = () => {
  return (
    <div className='bg-[#211E6D]  rounded-3xl flex flex-col md:flex-row'>
      <div className='flex flex-col justify-between p-16'>
        ...
        <div className='px-10 py-2 my-3 cursor-pointer w-fit text-[#211E6D] font-medium bg-white hover:bg-sky-700 transition-all hover:text-white rounded-lg shadow-lg'>
          Connect Us
        </div>
      </div>
